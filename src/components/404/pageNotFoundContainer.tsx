...
export function PageNotFoundContainer() {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center pb-20">
      ...
      <div className="text-[3rem] md:text-[4rem] font-semibold leading-15">
        <h1 className="text-emerald-900">SORRY, THERE'S</h1>
        <h1 className="text-gray-400">NOTHING HERE!</h1>
      </div>

      <button onClick={() => window.location.href = "/"} className="w-[90%] md:w-auto px-10 py-4 md:py-3 bg-emerald-900 hover:bg-emerald-700 font-semibold md:font-normal text-2xl md:text-[16px] text-white rounded-[8px] cursor-pointer my-5 transition-colors duration-00 ease-in-out">Home</button>
    </section>
  );
}