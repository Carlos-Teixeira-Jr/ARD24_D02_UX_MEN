...
export function AboutUsTopBanner() {
    ...
    const icons = [
        ...
        {
            key: "javascript",
            iconComponent: _jsx(JavascriptIcon, {}),
            label: "JavaScript",
        ...
        {
            key: "typescript",
            iconComponent: _jsx(TypescriptIcon, {}),
            label: "TypeScript",
        ...
        {
            key: "tailwind",
            iconComponent: _jsx(TailwindIcon, {}),
            label: "Tailwind",
    ...
    return (_jsx("main", { className: "flex md:flex-row flex-col gap-5 md:gap-14", children: _jsxs("div", { className: "flex-1 flex flex-col md:flex-row gap-5", children: [_jsxs("div", { className: "gap-6 flex flex-col flex-1 px-5 md:px-16 py-5 md:py-9", children: [_jsx("h1", { className: "font-secondary text-primary text-titles font-bold text-4xl", children: "About Us" }), _jsxs("p", { className: "font-inter text-[#64748B] font-normal", children: ["The ", _jsx("strong", { children: "UX-MEN" }), " team specializes in React, TypeScript, and Tailwind CSS, crafting modern and scalable user interfaces. We focus on clean architecture, reusable components, and performance optimization, ensuring seamless user experiences. Our expertise includes state management, API integration, and UI/UX best practices, delivering high-quality and maintainable code across diverse projects."] }), _jsx("h2", { className: "font-secondary text-primary text-titles font-bold text-4xl md:mt-20", children: "Tech Stack" }), _jsx("div", { className: "flex justify-between min-h-29", children: icons.map((icon) => (_jsxs("div", { className: "flex flex-col items-center cursor-pointer", onMouseEnter: () => setHoveredIcon(icon.key), onMouseLeave: () => setHoveredIcon(null), onClick: () => handleIconClick(icon.key), children: [icon.iconComponent, hoveredIcon === icon.key && (_jsx("span", { className: `text-sm text-gray-500 ${icon.key !== "typescript" && "mt-6"}`, children: _jsx("strong", { children: icon.label }) }))] }, icon.key))) }), _jsx("p", { className: `font-inter text-[#64748B] font-normal transition-opacity duration-500 ease-in-out ${techStachText.text ? "opacity-100" : "opacity-0"}`, children: techStachText.text })] }), _jsx("div", { className: "flex-1", children: _jsx("img", { src: plantImage, className: "w-full h-full object-cover" }) })] }) }));
}
